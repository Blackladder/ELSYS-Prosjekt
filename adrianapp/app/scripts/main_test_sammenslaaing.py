...
#        self.logger = stk.logging.get_logger(qiapp.session, self.APP_ID)
	...
	def simon_button_pressed(self,channel):
		buttonNr=channel
		...
		if buttonNr == self.buttonSequence[self.buttonPressedCount]:
			...
			self.buttonPressedCount = 0
			self.simon_game_over()

	def simon_button_1_pressed(self):
		self.simon_button_pressed(1)

	def simon_button_2_pressed(self):
		self.simon_button_pressed(2)

	def simon_button_3_pressed(self):
		self.simon_button_pressed(3)

	def simon_button_4_pressed(self):
		self.simon_button_pressed(4)
	...
	#	if not( self.isButtonCallbackRegistered ):
		...
		self.b1.when_pressed = self.simon_button_1_pressed
		self.b2.when_pressed = self.simon_button_2_pressed
		self.b3.when_pressed = self.simon_button_3_pressed
		self.b4.when_pressed = self.simon_button_4_pressed
