...
class Activity(object):
    ...
    def human_tracked(self,pid):
    	print("People found with id:" + str(pid))
    	...
    	if pid != -1:
    		...
    		#smile_properties = self.events.get("PeoplePerception/Person/" + str(pid) + "/SmileProperties")
    		#gender_properties = self.events.get("PeoplePerception/Person/" + str(pid) + "/GenderProperties")
    		#age = self.events.get("PeoplePerception/Person/" + str(pid) + "/AgeProperties")
    		
    		print("Shirtcolor:" + shirtColor)
    		print("Seenfor:" + str(seenFor))
    		print("Distance:" + str(distance))
    		#print("Age:" + age)
    		#print("SmileProperties:" + str(smile_properties))
    		#print("GenderProperties:" + str(gender_properties))
